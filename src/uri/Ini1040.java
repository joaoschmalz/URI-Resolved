...
public class Ini1040 {
    ...
    public static void average(){
        ...
        //Executa o cálculo da média ponderada
        double average = ((N1 * 2) + (N2 * 3) + (N3 * 4) + N4)/10;
        //Imprime a média com 1 casa após a vírgula
        System.out.println("Media: "+ df.format(average));

        //Valida a média do aluno
        if(average >= 7){
            ...
            //Imprime em tela a média final com apenas 1 casa após a vírgula
